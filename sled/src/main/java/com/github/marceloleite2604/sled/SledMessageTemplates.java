...
final class SledMessageTemplates {
	...
	static final String CRYPTOGRAPHIC_ALGORITHM_CANNOT_BE_NULL = "Cryptographic algorithm cannot be null.";
	...
	static final String KEY_ENVIRONMENT_VARIABLE_WAS_NOT_INFORMED = "Key environment variable name was not informed.";

	static final String COULD_NOT_FIND_ENCRYPT_KEY_ENVIRONMENT_VARIABLE = "Could not find encrypt key environment variable \"%s\".";
