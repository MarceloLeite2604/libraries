...
public class LocalTimeUtil {
	 ...
	 * @param duration
	 *            Interval duration.
	 * @return {@code true} if time is on specified time interval, {@code false}
	 *         otherwise.
	 */
	public boolean isBetween(LocalTime time, LocalTime startTime, Duration duration) {
		...
		return (timeToCheckInSeconds >= startTimeInSeconds
				&& timeToCheckInSeconds < endTimeInSeconds);
	}
	 ...
	 * @param text
	 *            Text to be parsed.
	 * @return A {@link LocalTime} object with the value parsed from
	 *         {@code parameter}.
	 */
	 ...
	 * @param localTime
	 *            time to be written.
	 * @return A preformatted text with the content of the {@code localTime}
	 *         parameter.
	 */
