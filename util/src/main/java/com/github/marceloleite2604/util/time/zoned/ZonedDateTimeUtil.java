...
public class ZonedDateTimeUtil {
	 ...
	 *            Start time interval (inclusive).
	 * @param endExclusive
	 *            End time interval (exclusive).
	 * @return {@code true} if date is inside the time interval specified,
	 ...
	 * 
	 * @param epochTime
	 *            The epoch time to be converted.
	 * @return A {@link ZonedDateTime} object with time specified on
	 *         {@code epochTime} parameter.
	 */
	 ...
	 * 
	 * @param zonedDateTime
	 *            Time to convert as text.
	 * @return The preformatted text elaborated from {@code zonedDateTime}
	 *         parameter.
	 */
	 ...
	 * @param text
	 *            Text to be parsed.
	 * @return A {@link ZonedDateTime} containing the date specified on the
	 *         predefined text.
	 */
	...
	/**
	 * Converts a {@link ZonedDateTime} object to another {@link ZonedDateTime}
	 * object, but using system default zone id.
	 * 
	 * @param zonedDateTime
	 *            Time to be converted.
	 * @return A {@link ZonedDateTime} object with time informed on
	 *         {@code zonedDateTime} parameter converted to system default zone id.
	 */
	...
	/**
	 * Converts a {@link ZonedDateTime} object to another {@link ZonedDateTime}
	 * object, but using the zone id specified on
	 * {@link ZonedDateTimeUtil#DEFAULT_ZONE_ID} constant.
	 * 
	 * @param zonedDateTime
	 *            Time to be converted.
	 * @return A {@link ZonedDateTime} object with time informed on
	 *         {@code zonedDateTime} parameter converted to this class default zone
	 *         id.
	 */
	 ...
	 * 
	 * @param zonedDateTime
	 *            Time to convert as timestamp text.
	 * @return The preformatted timestamp text elaborated from {@code zonedDateTime}
	 *         parameter.
	 */
	 ...
	 * @return A {@link ZonedDateTime} object with the time specified on
	 *         {@code text} parameter.
	 */
