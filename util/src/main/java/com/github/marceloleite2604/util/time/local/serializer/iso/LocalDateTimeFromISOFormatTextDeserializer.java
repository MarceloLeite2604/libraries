 ...
 * </p>
 * <p>
 * Its serialization equivalent can be found on {@link LocalDateTimeToISOFormatTextSerializer}
 * class.
 * </p>
 *
 ...
 *
 */
public class LocalDateTimeFromISOFormatTextDeserializer extends StdDeserializer<LocalDateTime> {

  private static final long serialVersionUID = 1L;

  private final transient LocalDateTimeUtil localDateTimeUtil;

  public LocalDateTimeFromISOFormatTextDeserializer() {
  ...
  public LocalDateTime deserialize(JsonParser jsonParser, DeserializationContext context)
      throws IOException {
    return localDateTimeUtil.parseFromISOFormat(jsonParser.getText());
  }
