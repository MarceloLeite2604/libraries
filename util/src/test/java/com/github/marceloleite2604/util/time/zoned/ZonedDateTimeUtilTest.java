...
public class ZonedDateTimeUtilTest {
	...
	public void testIsBetweenZonedDateTimeInsideBounds() throws Exception {
		// Arrange
		ZonedDateTime lowerLimit = ZonedDateTime.of(LocalDateTime.of(2018, 9, 26, 10, 13),
				ZoneIds.GMT_PLUS_3);
		ZonedDateTime upperLimit = ZonedDateTime.of(LocalDateTime.of(2018, 9, 26, 12, 13),
				ZoneIds.GMT_PLUS_3);
		ZonedDateTime zonedDateTime = ZonedDateTime.of(LocalDateTime.of(2018, 9, 26, 10, 13),
				ZoneIds.GMT_PLUS_FOUR);
	...
	public void testIsBetweenZonedDateTimeLowerLimitInclusive() throws Exception {
		// Arrange
		ZonedDateTime lowerLimit = ZonedDateTime.of(LocalDateTime.of(2018, 9, 26, 10, 13),
				ZoneIds.GMT_MINUS_TWO);
		ZonedDateTime upperLimit = ZonedDateTime.of(LocalDateTime.of(2018, 9, 26, 12, 13),
				ZoneIds.GMT_PLUS_3);
		ZonedDateTime zonedDateTime = ZonedDateTime.of(LocalDateTime.of(2018, 9, 26, 12, 13),
				ZoneIds.GMT);
	...
	public void testIsBetweenZonedDateTimeUpperLimitExclusive() throws Exception {
		...
		ZonedDateTime upperLimit = ZonedDateTime.of(LocalDateTime.of(2018, 9, 26, 12, 13),
				ZoneIds.GMT_PLUS_3);
		ZonedDateTime zonedDateTime = ZonedDateTime.of(LocalDateTime.of(2018, 9, 26, 15, 13),
				ZoneIds.GMT);
	...
	public void testIsBetweenWithTimeInterval() throws Exception {
		// Arrange
		ZonedDateTime start = ZonedDateTime.of(LocalDateTime.of(2018, 9, 26, 10, 13),
				ZoneIds.GMT_PLUS_3);
		ZonedDateTime end = ZonedDateTime.of(LocalDateTime.of(2018, 9, 26, 12, 13),
				ZoneIds.GMT_PLUS_3);
	...
	public void testToDefaultZoneId() throws Exception {
		...
		ZonedDateTime zonedDateTime = ZonedDateTime.of(LocalDateTime.of(2018, 9, 26, 16, 4, 17),
				ZoneIds.GMT_PLUS_NINE);
		ZonedDateTime expectedZonedDateTime = ZonedDateTime
				.of(LocalDateTime.of(2018, 9, 26, 7, 4, 17), ZoneId.of("UTC"));
	...
	@Test
		public void testToStringAsTimestamp() throws Exception {
			...
			ZonedDateTime zoneDateTime = ZonedDateTime.of(
					LocalDateTime.of(2018, 9, 26, 15, 52, 59, 612000000),
					ZoneIds.GMT_PLUS_3.normalized());
	...
	@Test
		public void testToStringFromWrittenTimestamp() throws Exception {
			...
			ZonedDateTime expectedZoneDateTime = ZonedDateTime.of(
					LocalDateTime.of(2018, 9, 26, 15, 52, 59, 612000000),
					ZoneIds.GMT_PLUS_3.normalized());
	...
	public void testToSystemDefaultZoneId() throws Exception {
		// Arrange
		ZonedDateTime zonedDateTime = ZonedDateTime.of(2019, 8, 30, 10, 26, 7, 0,
				ZoneIds.GMT_PLUS_ONE);
