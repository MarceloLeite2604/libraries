...
/**
 * The Blimp is a Basic Library for Internationalized Messages Pursuit. It helps
 * retrieving internationalized messages from properties files.
 * 
...
public class Blimp {
	...
	/**
	 * Constructs a Blimp object, retrieving message properties from file paths
	 * informed on {@code messagesFilePaths} using {@link Blimp#DEFAULT_LOCALE}
	 * locale.
	 * 
	 * @param messagesFilePaths
	 *            A list of file paths to search for message properties.
	 */
	...
	/**
	 * Constructs a Blimp object, retrieving message properties from file paths
	 * informed on {@code messagesFilePaths} using locale informed on {@code locale}
	 * parameter.
	 * 
	 * @param locale
	 *            Locale which will be used to retrieve message properties.
	 * @param messagesFilePaths
	 *            A list of file paths to search for message properties.
	 */
	 ...
	 *            Locale which will be used to retrieve message properties.
	 * @param messagesFilePaths
	 *            File paths to search for message properties.
	 */
	...
	/**
	 * Constructs a Blimp object, retrieving messages from {@link MessageSource}
	 * informed on {@code messageSource} parameter using
	 * {@link Blimp#DEFAULT_LOCALE} locale.
	 * 
	 * @param messageSource
	 *            The message source used for messages retrieval.
	 */
	...
	/**
	 * Constructs a Blimp object, retrieving messages from {@link MessageSource}
	 * informed on {@code messageSource} parameter using locale informed on
	 ...
	 * @param parameters
	 *            Parameters to inform on message elaboration.
	 ...
	 * 
	 * @param singular
	 *            When {@code true} the singular message will be retrieved.
	 *            Otherwise, its plural equivalent will be used.
	 * @param message
	 *            {@link Message} object which contains the message code.
	 * @return The message retrieved filled with the parameters informed.
	 */
