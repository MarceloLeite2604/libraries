...
public class Flask {
	 ...
	 * 
	 * @param directory
	 *            Directory which text file paths informed on load methods will
	 *            start.
	 */
	 ...
	 * 
	 * @param filePath
	 *            Path to the text file which the content should be loaded. If a
	 *            directory was defined on Flask instantiation, the path must start
	 *            from this directory.
